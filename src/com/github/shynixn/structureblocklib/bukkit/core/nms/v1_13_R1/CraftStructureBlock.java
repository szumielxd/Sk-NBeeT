package com.github.shynixn.structureblocklib.bukkit.core.nms.v1_13_R1;
...
public class CraftStructureBlock extends CraftBlockState implements StructureBlockData, StructureBlockSave, StructureBlockLoad {
    ...
    private void refresh() {
        ...
        this.mode = getBlockUseage(BlockPropertyStructureMode.valueOf(compound.getString("mode")));
    ...
    private static StructureMode getBlockUseage(BlockPropertyStructureMode usageMod) {
        switch (usageMod) {
            case CORNER:
